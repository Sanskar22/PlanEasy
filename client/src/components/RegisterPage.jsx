        ...
        <div className=" flex grow justify-around items-center">
            <div className=" border-t-8 rounded-sm border-primary bg-white p-8 shadow-2xl w-96">
                ...
                <form onSubmit={registerUser}>
                    ...
                    <button className="mt-6 transition transition-all block py-3 px-4 w-full text-white font-bold rounded cursor-pointer bg-gradient-to-r from-primary to-secondary hover:from-primary hover:to-secondary focus:bg-indigo-900  transform hover:-translate-y-1 hover:shadow-lg" value="Submit" >
                        Register
                    </button>
